...
from Utils.utils_data import read_cea_target, read_cta_target, read_cpa_target,\
    write_semtab21_biodivtab_CEA_result, write_CTA_result, write_CPA_result, load_cache_result
...
if __name__ == "__main__":
    ...
    write_CTA_result(os.path.join(result_dir, 'CTA', "CTA.csv"),
                     col_types, cta_targets, wikidata_prefix="https://www.wikidata.org/wiki/")

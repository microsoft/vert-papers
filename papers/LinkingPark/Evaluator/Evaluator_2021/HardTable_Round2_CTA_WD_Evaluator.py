...
if __name__ == "__main__":
    ...
    answer_file_path = os.path.join(args.gt_dir, "HardTablesR2_CTA_WD_gt.csv")
    ...
    result = aicrowd_evaluator._evaluate(_client_payload,
                                         os.path.join(args.gt_dir, "HardTablesR2_CTA_WD_gt_ancestor.json"),
                                         os.path.join(args.gt_dir, "HardTablesR2_CTA_WD_gt_descendent.json"),
                                         _context)
    print(result)

...
if __name__ == "__main__":
    ...
    parser.add_argument("--gt-fn",
                        type=str,
                        default="/home/datadrive/Workspace/Data/SemTab/Benchmark/SemTab2021/Round3/BioDivTab/gt/CEA_biodivtab_2021_gt.csv")
    parser.add_argument("--submission-fn",
                        type=str,
                        default="/home/datadrive/Workspace/Data/SemTab/Submission/Semtab21_round3_biodivtable_wikidata_20210830_header/CEA/CEA.csv")
    args = parser.parse_args()
    # Lets assume the the ground_truth is a CSV file
    # and is present at data/ground_truth.csv
    # and a sample submission is present at data/sample_submission.csv
    answer_file_path = args.gt_fn
    submission_file_path = args.submission_fn
    _client_payload = {}
